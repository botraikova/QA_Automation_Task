...
public class PersonalAccountIndividualRegistrationTest extends TestAndDriverSetup {

    @Test
    public void registrationForPersonalAccountIndividualTest(){
        ...
        registerPage.clickIndividualForPersonal();
